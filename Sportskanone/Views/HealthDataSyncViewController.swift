//
//  HealthDataSyncViewController.swift
//  Sportskanone
//
//  Created by Fabian Pahl on 30.03.17.
...
final class HealthDataSyncViewController<Store: StoreType>: UIViewController {
  ...
  private let viewModel: HealthDataSyncViewModel<Store>
  
  // MARK: - Object Life Cycle
  
  init(viewModel: HealthDataSyncViewModel<Store>) {
  ...
  override func loadView() {
    ...
    verticalStackView.addArrangedSubview(UIView())
    verticalStackView.addArrangedSubview(UIView())
    verticalStackView.addArrangedSubview(activityView)
  ...
  override func viewDidLoad() {
    ...
    viewModel.healthDataSyncAction.errors
  ...
  override func viewDidAppear(_ animated: Bool) {
    ...
    viewModel.healthDataSyncAction.apply().start()
  }
  ...
  func setupBindings() {
    ...
    activityView.reactive.isAnimating <~ viewModel.healthDataSyncAction.isExecuting
  }
